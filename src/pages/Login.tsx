    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-muted/40">
      ...
      <div className="w-full max-w-md space-y-8">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-3xl font-bold">NoticeNexus</h1>
        ...
        <div className="text-center text-sm text-muted-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mt-2">
            <div className="bg-card p-2 rounded-md border">
              ...
              <p className="text-xs">Password: hiss</p>
            </div>
            <div className="bg-card p-2 rounded-md border">
              <p className="font-medium">Teacher</p>
              <p className="text-xs">teacher1@school.edu</p>
              <p className="text-xs">Password: password123</p>
            </div>
            <div className="bg-card p-2 rounded-md border">
              <p className="font-medium">Student</p>
              <p className="text-xs">student1@school.edu</p>
              <p className="text-xs">Password: password123</p>
            </div>
          </div>
        </div>
